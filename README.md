# 🏛️ Historical Society of Millersburg & Upper Paxton Township
### Digital Photo Archive, Metadata Indexer & Upload System

[![License: MIT](https://img.shields.io/badge/License-MIT-gold.svg)](LICENSE)
[![Platform: Azure](https://img.shields.io/badge/Hosted--On-Azure%20Static%20Web%20Apps-0078D4.svg)](https://azure.microsoft.com)
[![Auth: Entra ID](https://img.shields.io/badge/Auth-Microsoft%20Entra%20ID-2899F5.svg)](https://entra.microsoft.com)
...
- **Instant Keyword & Tag Search:** Query historical records by title, year (1800s–2000s), location (*Susquehanna River, Center St, Market Square, Berry Mountain*), photographer, donor, and tags.
...
### 🛡️ 3. Microsoft Entra ID & Local Authentication
...
## ☁️ Azure Deployment Guide ($0/month Hosting)
